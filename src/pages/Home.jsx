    ...
    <div className="home__container">
        ...
        <section className="section__about" style={sectionStyle} id="about">
            ...
            <p className="about__description">
                ...
                Si vous souhaitez en savoir plus au sujet de mon parcours, je vous invite à consulter mon <a target="_blank" href="../../public/images/CV_LoïcGalland.pdf" className="link__text">curriculum vitae</a>
